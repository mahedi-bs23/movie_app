...
class SettingScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final List<Movie> movieList = HomeViewmodel().topMovies;
    return Scaffold(
                                      ...
                                      children: [
                                        ...
                                        SizedBox(
                                          ...
                                          child: AddWatchlistButton(
                                            onPressed: () {
                                              print(
                                                  "WatchList Length: ${favouriteViewmodel.watchList.value.length}");
                                              favouriteViewmodel.watchList.value
                                                  .add(
                                                Movie(
                                                  name: movieList[index].name,
                                                  image: movieList[index].image,
                                                  releaseYear: movieList[index]
                                                      .releaseYear,
                                              ...
                                              print(
                                                  "Movie Name: ${favouriteViewmodel.watchList.value[favouriteViewmodel.watchList.value.length-1].name}");
                                            },
                                          ),
                                        ),
                                      ],
